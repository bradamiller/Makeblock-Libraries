 ...
 * license \n conditions. The main licensing options available are GPL V2 or
 * Commercial: \n
 *
 * \par Open Source Licensing GPL V2
 * This is the appropriate option if you want to share the source code of your
 * \n application with everyone you distribute it to, and you also want to give
 * them \n the right to share who uses it. If you wish to use this software
 * under Open \n Source Licensing, you must contribute all your source code to
 * the open source \n community in accordance with the GPL Version 2 when your
 ...
 * Mark Yan         2016/02/20          1.0.1            Change the port
 * enumeration Scott wang       2016/09/18          1.0.2            Add the
 * PORT[15]. Scott            2016/09/20          1.0.3            Add the
 * PORT[16]. Scott            2016/09/23          1.0.4            Add the
 * MePS2.h . Zzipeng          2016/12/15          1.0.5            Add the
 * MePm25Sensor.h .
 * </pre>
 */
#ifndef MeAuriga_H
